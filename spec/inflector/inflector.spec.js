...
describe("Inflector", function() {
  ...
  describe("String#possessiveize", function() {
    it("adds apostrophe + s to the singular form of a word", function() {
      expect("owner".possessiveize()).toEqual("owner's");
      expect("octopus".possessiveize()).toEqual("octopus's");
      expect("duchess".possessiveize()).toEqual("duchess's");
    });

    it("adds apostrophe + s to the plural forms that do not end in -s", function() {
      expect("children".possessiveize()).toEqual("children's");
      expect("geese".possessiveize()).toEqual("geese's");
    });

    it("adds apostrophe to the plural forms that end in -s", function() {
      expect("cats".possessiveize()).toEqual("cats'");
      expect("friends".possessiveize()).toEqual("friends'");
      expect("countries".possessiveize()).toEqual("countries'");
    });

    it("adds apostrophe + s to the end of compound words", function() {
      expect("brother-in-law".possessiveize()).toEqual("brother-in-law's");
    });

    it("adds apostrophe + s to the last noun showing joint possession", function() {
      expect("Todd and Anne".possessiveize()).toEqual("Todd and Anne's");
    });
  });
